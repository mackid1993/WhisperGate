...
public class NoiseGateEngine
{
    ...
    public void EngageGate()
    {
        ...
        try
        {
            ...
            _savedMute = _device.AudioEndpointVolume.Mute;
            ...
            // Close gate: mute mode uses mute flag, volume mode reduces volume
    ...
    public void DisengageGate()
    {
        ...
        if (_device != null)
        {
            try
            {
                _device.AudioEndpointVolume.Mute = _savedMute;
                _device.AudioEndpointVolume.MasterVolumeLevelScalar = _savedVolume;
            }
            catch { }
            _device = null;
        }
    ...
    {
        try { if (_device != null) _device.AudioEndpointVolume.Mute = muted; }
        catch { }
    }
}
